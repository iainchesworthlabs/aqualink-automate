<!-- GENERATED from ../aqualink-automate — do not edit; see scripts/gen-homeassistant-edge-addon.ps1 -->

> **Edge (beta) channel.** Tracks the newest prerelease. For the stable channel install **Aqualink Automate** instead.
