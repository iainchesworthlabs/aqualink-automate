...
namespace
{
	...
	public:
		...
		CommandResult SetChlorinatorPercentage(std::uint8_t pct, AqualinkAutomate::Kernel::BodyOfWaterIds) override { chlorinator_percentages.push_back(pct); return CommandResult::Success; }
